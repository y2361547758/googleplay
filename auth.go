...
func (a Auth) Delivery(dID, app string, ver int) (*Delivery, error) {
...
// `dID` is Google Service Framework.
func (a Auth) Details(dID, app string) (*Details, error) {
...
// Only way I know to check, it to try the `dID` with a `details` request or
// similar. Also, after the POST, you need to wait at least 16 seconds before
// the `dID` can be used.
func (a Auth) Upload(dID string, dev Device) error {
